...
func TestDockerContainerSpec(t *testing.T) {
	...
	if cgroups.IsCgroup2UnifiedMode() {
		...
		// And cAdvisor will convert cpu.weight back to cpu shares in https://github.com/yidoyoon/cadvisor-lite/blob/24e7a9883d12f944fd4403861707f4bafcaf4f3d/container/common/helpers.go#L249-L260
		// Worked example:
